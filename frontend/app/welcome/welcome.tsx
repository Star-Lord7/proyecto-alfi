...
export function Welcome() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="container mx-auto px-6 lg:px-10 py-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-3">
            <img src={logo} alt="ALFI logo" className="h-12 w-auto ml-8" />
          </div>
      ...
      {/* HERO */}
      <section className="pt-0 px-6 lg:px-16">
        <div className="bg-[#02734A] rounded-2xl p-8 lg:p-14 shadow-xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">

            <div className="space-y-6 text-white">
              <span className="inline-flex items-center bg-white/15 px-4 py-2 rounded-full text-sm font-semibold">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <button
                  ...
                  className="px-8 py-4 rounded-xl border-2 border-white font-semibold hover:bg-white/10 transition"
                >
                  Saber más
                </button>
              </div>
      ...
      <section className="container mx-auto px-6 lg:px-10 py-16 lg:py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {[
            ...
            <div
              key={title}
              className="h-full flex flex-col justify-between bg-white rounded-2xl shadow-md p-8 hover:shadow-2xl hover:-translate-y-2 transition border border-gray-100"
            >
              <div>
...
<Link to="/login">
      ...
      {openModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-4 w-[90%] max-w-3xl relative animate-fadeIn">
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/qlJ69Ev84ZQ"
              title="Video"
              allowFullScreen
            />
          </div>
