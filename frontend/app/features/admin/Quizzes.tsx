...
export default function RevisarTarjetas() {
    ...
    const [estadoFiltro, setEstadoFiltro] = useState<EstadoFiltro>("PENDIENTE_REVISION");
    ...
    useEffect(() => {
        ...
        .catch(() =>
        setError("Ocurrió un error al cargar las tarjetas")
        )
    ...
    const handleChangeEstado = async (nuevoEstado: "APROBADA" | "RECHAZADA") => {
        ...
        try {
            const res = await fetch("http://localhost:3000/api-alfi/tarjetas/estado", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
            ...
            <div className="bg-white rounded-xl shadow-xl max-w-xl w-full mx-4 relative flex flex-col max-h-[85vh]">
                ...
                <div className="p-6 border-b">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Dificultad: <span className="font-semibold">{tarjetaSeleccionada.dificultad}</span>
                    </p>
                </div>
                ...
                <div className="p-6 overflow-y-auto flex-1">
                    ...
                    <div key={opcion.id} className="border rounded-lg p-4 space-y-2">
                        {modoEdicion ? (
                        <>
                            <input
                            value={opcion.descripcion}
                            onChange={(e) => {
                                const nuevasOpciones = [...tarjetaSeleccionada.opciones];
