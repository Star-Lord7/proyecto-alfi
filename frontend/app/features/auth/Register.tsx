      ...
      <div className="relative z-10 w-full max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Crea tu cuenta y comienza a aprender con ALFI
          </p>
        </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="text-gray-900 placeholder-gray-400 w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all outline-none"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="text-gray-900 placeholder-gray-400 w-full pl-10 pr-12 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all outline-none"
                        placeholder="••••••••"
                        required
                      />
                      <button
...
w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all outline-none"
                  ...
                  <div>
                    ...
                    <input
                     ...
                     onChange={(e) => setApellido(e.target.value)}
                      className="text-gray-900 placeholder-gray-400 w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all outline-none"
                      placeholder="Pérez"
                      required
                    />
                  </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="3">Joven adulto</option>
