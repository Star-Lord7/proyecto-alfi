...
CREATE TABLE `segmentos` (
    ...
    UNIQUE INDEX `segmentos_nombre_key`(`nombre`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `paises` (
    ...
    UNIQUE INDEX `paises_nombre_key`(`nombre`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `puntajes_usuario` ADD CONSTRAINT `puntajes_usuario_perfilId_fkey` FOREIGN KEY (`perfilId`) REFERENCES `perfiles`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `perfiles` ADD CONSTRAINT `perfiles_paisId_fkey` FOREIGN KEY (`paisId`) REFERENCES `paises`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `perfiles` ADD CONSTRAINT `perfiles_segmentoId_fkey` FOREIGN KEY (`segmentoId`) REFERENCES `segmentos`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Token` ADD CONSTRAINT `Token_usuarioId_fkey` FOREIGN KEY (`usuarioId`) REFERENCES `usuarios`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
